-- Миграция 010: Наполнение базового контента
-- Исправлено: Убраны INSERT в locations для избежания конфликта с миграцией 011
...
-- 2. ЛОКАЦИИ - ПЕРЕНЕСЕНО В МИГРАЦИЮ 014
-- Локации добавляются через migrate_locations_catalog.sql
