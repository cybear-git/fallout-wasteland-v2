...
ADD COLUMN boss_id INT DEFAULT NULL COMMENT 'ID монстра-босса из таблицы monsters',
...
-- ВАЖНО: boss_id должен быть INT (не UNSIGNED), чтобы соответствовать типу monsters.id
ALTER TABLE dungeons
